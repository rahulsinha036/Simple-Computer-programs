...
{
	ofstream out;
	out.open("D:\\F-KART.xls");
	out<<"                     USER INPUT                             ";
	out<<"\n";
	out<<"Pin code ----> "<<pin<<"\n";
	out<<"Your Home Address ----> "<<add<<"\n";
	out<<"City -->"<<city<<"\n";
    out<<"Name of Constumer ----> "<<fname<<"\n";
	out<<"Name of a item ----> "<<name<<"\n";
	out<<"Email id of constumer ---> "<<email<<"\n";
	out<<"Your password ----> "<<pass<<"\n";
	out<<"Your Mobile Number is ---> "<<a<<"\n";
	out<<"-------------------------------------------------------------------------------------------------------------------------------------";
	out<<"\n";
	out.close();
	cout<<"\n";
